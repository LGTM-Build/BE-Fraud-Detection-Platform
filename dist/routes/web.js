...
router.get("/api/procurement-monitor/:id", auth_middleware_1.authMiddleware, (0, require_role_middleware_1.requireRole)(["super_admin", "super_user", "auditor"]), procurement_controller_1.ProcurementController.detailMonitor);
router.post("/api/procurements", auth_middleware_1.authMiddleware, (0, require_role_middleware_1.requireRole)(["super_admin", "super_user"]), procurement_controller_1.ProcurementController.create);
router.put("/api/procurements/:id", auth_middleware_1.authMiddleware, (0, require_role_middleware_1.requireRole)(["super_admin", "super_user"]), procurement_controller_1.ProcurementController.update);
router.post("/api/procurement-monitor/:id/review", auth_middleware_1.authMiddleware, (0, require_role_middleware_1.requireRole)(["super_admin", "super_user", "auditor"]), procurement_controller_1.ProcurementController.review);
